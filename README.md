...
- [Request Examples (with parameters)](#request-examples)
   - [Specific country name](#data-of-one-specific-country)
   - [Countries with region and subRegion specifically](#data-of-countries-with-region-and-subregion-specifically)
      - [Region and sub region list](#region-and-sub-region-list)
   - [Countries with Alpha code 2 or 3](#data-of-the-country-with-alpha-code-2-or-3)
   - [Countries with english like native language](#data-of-the-countries-with-english-like-native-language)
   - [Countries with Currency code USD (United States Dollar)](#data-of-the-countries-with-currency-code-usd-united-states-dollar)
   - [Countries with an Area (km2) more than 8000 and less than 12000](#data-of-the-countries-with-an-area-km2-more-than-8000-and-less-than-12000)
   - [Countries with limit and pagination](#data-of-the-countries-with-limit-and-pagination)
